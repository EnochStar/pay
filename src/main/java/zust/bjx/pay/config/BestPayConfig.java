...
public class BestPayConfig {
    ...
    public BestPayService bestPayService() {
        ...
        wxPayConfig.setNotifyUrl("http://testi.cn1.utools.club/pay/notify");


        AliPayConfig aliPayConfig = new AliPayConfig();
        aliPayConfig.setAppId("2021000116667941");
        ...
        aliPayConfig.setNotifyUrl("http://testi.cn1.utools.club/pay/notify");
